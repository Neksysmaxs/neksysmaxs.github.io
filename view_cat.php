...
<head>
	...
	<title>Интернет магазин nugashopbestnuga</title>
</head>
...
}else
{
    ...
    $result = mysql_query("SELECT * FROM table_praducts WHERE visible='1' $querycat ORDER BY $sorting ",$link);	
